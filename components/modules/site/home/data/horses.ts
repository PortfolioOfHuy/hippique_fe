...
export const horses: HorseDetailItem[] = [
  {
    ...
    discipline: "Dressuur",
    description:
      "Imperial Majesty is een uitzonderlijke dressuurhengst met een indrukwekkende uitstraling, krachtige bewegingen en een uitstekend wedstrijdtemperament. Dit paard combineert souplesse, balans en elasticiteit met een bewezen internationale afstamming.",
  ...
  },
  {
    ...
    discipline: "Springen",
    description:
      "Silver Sovereign is een moderne springruin met vermogen, reflexen en een zeer voorzichtige techniek boven de hindernis. Ideaal voor ruiters die een competitief paard zoeken met internationale potentie.",
  ...
  },
  {
    ...
    discipline: "Springen",
    description:
      "Royal Vanguard is een opvallende hengst met veel bloed, atletisch vermogen en een sterke galop. Een uitstekend prospect voor ambitieuze ruiters en investeerders.",
    pedigree: ["Diamant de Semilly", "Baloubet du Rouet", "Quick Star"],
    highlights: [
      "Exclusieve afstamming",
      "Atletische bouw",
      "Commerciële waarde",
      "Veel uitstraling",
    ],
