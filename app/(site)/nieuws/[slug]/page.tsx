          ...
          <div className={styles.content}>
            ...
            <div className={styles.noteBox}>
              ...
              <div className={styles.noteActions}>
                ...
                <Link href="/advertentie-plaatsen">Advertentie plaatsen</Link>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className={styles.relatedGrid}>
          {relatedNews.map((item) => (
            <article key={item.id} className={styles.relatedCard}>
              <Link href={`/nieuws/${item.slug}`} className={styles.relatedImage}>
                <Image
                  src={item.image}
                  alt={item.imageAlt}
                  width={420}
              ...
              <div className={styles.relatedContent}>
                ...
                <Link href={`/nieuws/${item.slug}`} className={styles.relatedLink}>
                  Lees artikel
